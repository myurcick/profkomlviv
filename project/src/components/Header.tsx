        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-3">
              {/* Логотип - замініть src на шлях до вашого логотипу *//*}*//*
              <img 
                src="../../public/logo.jpg" 
                alt="Логотип профкому студентів ЛНУ" 
                className="h-10 w-10 object-contain"
                onError={(e) => {
                  // Fallback до іконки якщо зображення не завантажилось
                  e.currentTarget.style.display = 'none';
                  e.currentTarget.nextElementSibling?.classList.remove('hidden');
                }}
              />
              {/* Fallback іконка *//*}*//*
              <div className="hidden h-10 w-10 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-lg">
                ЛНУ
              </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link
              to="/admin/login"
              className="flex items-center space-x-1 px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50 transition-colors duration-200"
            >
